package ru.bikbaev.microservice_2.service;
...
import ru.bikbaev.microservice_2.data.ProductRepository;
...
public class PurchaseOrder {
    ...
    public PurchaseOrder(ProductRepository productRepository) {
    ...
    public List<Order> creatPurchaseOrder(){
        ...
        return creatOrder(products);


    }

    public void creat(List<Order>orders){
        createOrderXLS(orders);
    }
